...
[github.com/techyzer/techyzer/security/advisories/new](https://github.com/techyzer/techyzer/security/advisories/new)
...
the hosted instance (techyzer.com) or affects self-hosted deployments
...
- **Vulnerabilities in third-party dependencies** (Express, better-sqlite3,
  ...
  affects TechYzer in a non-obvious way, that's worth flagging here too.
