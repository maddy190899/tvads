...
export default {
  ...
  'dashboard.no_displays_desc': 'Install the TechYzer app on your TV and pair it using the button above.',
  ...
  'settings.hide_branding': 'Hide "TechYzer" branding',
  ...
  'settings.setup_step_1': 'Install the TechYzer APK on your TV via sideloading',
  ...
  'settings.import.invalid_file': 'Invalid file. Must be a TechYzer export JSON or ZIP.',
  ...
  'onboarding.step.welcome.title': 'Welcome to TechYzer!',
